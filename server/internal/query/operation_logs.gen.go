...
func newOperationLog(db *gorm.DB, opts ...gen.DOOption) operationLog {
	...
	_operationLog.ID = field.NewUint64(tableName, "id")
	_operationLog.OperatorID = field.NewUint64(tableName, "operator_id")
	_operationLog.OperatorRole = field.NewString(tableName, "operator_role")
	_operationLog.Action = field.NewString(tableName, "action")
	_operationLog.TargetType = field.NewString(tableName, "target_type")
	_operationLog.TargetID = field.NewUint64(tableName, "target_id")
	_operationLog.Detail = field.NewString(tableName, "detail")
...
type operationLog struct {
	...
	ALL          field.Asterisk
	ID           field.Uint64
	OperatorID   field.Uint64 // operator user id
	OperatorRole field.String // operator role
	Action       field.String // action
	TargetType   field.String // target type
	TargetID     field.Uint64 // target id
	Detail       field.String // detail
	IPAddress    field.String // ip address
...
func (o *operationLog) updateTableName(table string) *operationLog {
	...
	o.OperatorID = field.NewUint64(table, "operator_id")
	o.OperatorRole = field.NewString(table, "operator_role")
	o.Action = field.NewString(table, "action")
	o.TargetType = field.NewString(table, "target_type")
	o.TargetID = field.NewUint64(table, "target_id")
...
func (o *operationLog) fillFieldMap() {
	...
	o.fieldMap["operator_role"] = o.OperatorRole
